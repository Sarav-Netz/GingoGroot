...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-info">
        <div class="container-fluid">
            <a class="navbar-brand" href="managerInterface.php?home=true">Groot</a>
            ...
            <ul class="navbar-nav mb-2 mb-lg-0">
                ...
                ?>
                <a class="nav-link active" aria-current="page" href="managerInterface.php?myDetail=true"><?php echo ucwords($userDetail['userName']); ?></a>
                </li>
                <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="managerInterface.php?logMeOut=true">Log Out</a>
                </li>
            </ul>
            </div>
        </div>
